...
export default function ScrollPriceCard() {
  // Tell TypeScript course is of type Course or undefined
 const { course} = UseCourseHooks() as {
  course: Course | null
}
      ...
      >
        <Card className="w-96 shadow-lg border-2 border-blue-200 bg-white">
          <CardHeader>
            ...
            <a href="https://app.10minuteschool.com/checkout" target="_blank" rel="noreferrer">
